...
describe('mostBlogs', () => {
  test('given list of many blogs then returns author with largest amount of blogs', () => {
  ...
  test('given list with one blog the return author of said blog', () => {
    const listWithOneBlog = [
      {
        _id: '5a422aa71b54a676234d17f8',
        title: 'Go To Statement Considered Harmful',
  ...
  test('given empty list then should throw TypeError', () => {
    const emptyList = []
    expect( () => { listHelper.mostBlogs(emptyList) } ).toThrow(TypeError)
  })
})